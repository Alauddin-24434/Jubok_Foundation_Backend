...
async function bootstrap() {
  ...
  try {
    ...
    if (!adminUser) {
      logger.error(
        '❌ Admin user not found. Please run "npm run seed" first to create the admin user.',
      );
      process.exit(1);
    }
    ...
    const projects = [
      {
        ...
        raisedAmount: 350000,
        description:
          'Large scale organic rice farming in Dinajpur using sustainable methods. Weekly updates provided.',
      ...
      },
      {
        ...
        raisedAmount: 120000,
        description:
          'High-density fish farming using Biofloc technology in Mymensingh. Expected ROI 20%.',
      ...
      },
      {
        ...
        raisedAmount: 0,
        description:
          '10-story residential building in Uttara, Dhaka. Shariah-compliant investment model.',
      ...
      },
      {
        ...
        raisedAmount: 200000,
        description:
          'Expansion of existing mango orchard in Rajshahi. Fully funded and operational.',
        location: 'Rajshahi, Bangladesh',
        startDate: new Date('2023-01-01'),
        endDate: new Date('2023-12-31'),
        thumbnail:
          'https://images.unsplash.com/photo-1596463990833-289b43936630?q=80&w=2874&auto=format&fit=crop',
        images: [
      ...
      },
      {
        ...
        raisedAmount: 75000,
        description:
          'Upgrading equipment for a 5000-bird capacity poultry farm in Gazipur.',
      ...
      },
      {
        ...
        raisedAmount: 50000,
        description:
          'Setting up a modern dairy farm with high-yield breed cows in Pabna.',
      ...
      },
      {
        ...
        description:
          'Developing commercial plots near Purbachal New Town. High appreciation potential.',
      ...
      },
      {
        ...
        raisedAmount: 80000,
        description:
          'Community rooftop gardening project in Dhaka city to promote green living.',
        location: 'Mirpur, Dhaka',
        startDate: new Date('2024-02-01'),
        endDate: new Date('2024-08-01'),
        thumbnail:
          'https://images.unsplash.com/photo-1622383563227-044011358d20?q=80&w=2787&auto=format&fit=crop',
        images: [
          'https://images.unsplash.com/photo-1622383563227-044011358d20',
        ],
      ...
      },
      {
        ...
        raisedAmount: 0,
        description:
          'Establishing a modern shrimp processing plant for export in Khulna.',
        location: 'Khulna, Bangladesh',
        startDate: new Date('2024-07-01'),
        endDate: new Date('2025-07-01'),
        thumbnail:
          'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?q=80&w=2874&auto=format&fit=crop',
        images: [
      ...
      },
      {
        ...
        raisedAmount: 80000,
        description:
          'High-yield lemon orchard project in Tangail. Completed successfully.',
        location: 'Tangail, Bangladesh',
        startDate: new Date('2023-03-01'),
        endDate: new Date('2023-09-01'),
        thumbnail:
          'https://images.unsplash.com/photo-1595855709915-393ae1c55536?q=80&w=2940&auto=format&fit=crop',
        images: [
          'https://images.unsplash.com/photo-1595855709915-393ae1c55536',
        ],
      ...
      },
      {
        ...
        raisedAmount: 100000,
        description:
          'Pilot project for vertical farming of leafy greens in Bashundhara R/A.',
        location: 'Bashundhara, Dhaka',
        startDate: new Date('2024-04-01'),
        endDate: new Date('2024-10-01'),
        thumbnail:
          'https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?q=80&w=2940&auto=format&fit=crop',
        images: [
      ...
      },
      {
        ...
        raisedAmount: 20000,
        description:
          'Sustainable mud crab fattening project in Satkhira coastal region.',
        location: 'Satkhira, Bangladesh',
        startDate: new Date('2024-05-15'),
        endDate: new Date('2024-11-15'),
        thumbnail:
          'https://images.unsplash.com/photo-1551817958-8686a3782c3d?q=80&w=2070&auto=format&fit=crop',
