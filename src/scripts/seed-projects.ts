  ...
  try {
    ...
    const projects = [
      ...
      },
      {
        ...
        intialInvestment: 5000000,
        description: '10-story residential building in Uttara, Dhaka.',
